...
{
	[AbaSim.Core.Compiler.Parsing.AssemblyCode("sleu", OpCode, Compiler.Parsing.InstructionType.Register, ConstantRestriction = AbaSim.Core.Compiler.Parsing.ConstantValueRestriction.Unsigned)]
